...
MODEL_PATH = os.path.join(settings.BASE_DIR, "model", "rf_style_model.joblib")
LABEL_PATH = os.path.join(settings.BASE_DIR, "model", "style_label.pkl")
...
def predict(features):
  ...
  """
  try:
    prediction = rf_model.predict(features)  # 특징 벡터를 모델에 입력
